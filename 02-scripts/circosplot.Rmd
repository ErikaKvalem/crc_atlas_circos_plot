...
primary_tumor_patient_stratification_tumor_cells <- read.csv("/data/scratch/kvalem/projects/2022/crc_atlas_circos_plot/02-scripts/epithelial_cancer_old_atlas.csv", row.names=1)
```
...
edge_color_scale <- scale_edge_color_gradientn(
 ...
 limits = c(-3,3),   values = scales::rescale(c(-3, 0, 3), to = c(0, 1)) 
)
...
ggsave("circos_plot_core_atlas_old.pdf", plot = p, width = 55, height = 45, units = "cm")
```
