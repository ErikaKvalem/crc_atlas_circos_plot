...
liana_res = read.csv("/data/scratch/kvalem/projects/2022/crc_atlas_circos_plot/02-scripts/final_scripts/002_analysis/res_df_ss_lastest_25nov_grouped_subset.csv")
...
```{r}
tumor_normal_interactions = liana_res|>
  select(source=source_genesymbol, target=target_genesymbol, fraction_expressed, fdr=fdr, log2_fc=log2FoldChange, cluster_2=cell_type_fine, pvalue) |>
...
```{r}
cpdb_res <- cpdb_res[!duplicated(cpdb_res$variable), ]
```
